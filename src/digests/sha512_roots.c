...
uint64_t	sha512_root_1(uint64_t i)
{
	const uint64_t	out[40] = {0x428a2f98d728ae22, 0x7137449123ef65cd,
...
uint64_t	sha512_root_2(uint64_t i)
{
	const uint64_t	out[40] = {0xa2bfe8a14cf10364,
...
{
	if (i < 40)
		return (sha512_root_1(i));
	else
		return (sha512_root_2(i - 40));
}
